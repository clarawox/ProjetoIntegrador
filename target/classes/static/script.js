    ...
    despesas.forEach(function (d) {
        ...
        switch (d.donut) {
            ...
            case '5':
                ...
                break
            case '6':
                d.donut = 'Recheado Chocolate';
                break
            case '7':
                d.donut = 'Recheado Nutella';
                break
            case '8':
                d.donut = 'Recheado Morango';
                break
            case '9':
                d.donut = 'Recheado Goiabada';
                break
            case '10':
                d.donut = 'Recheado Doce de Leite';
                break
            case '11':
                d.donut = 'Recheado Leite Ninho';
                break
            case '12':
                d.donut = 'Recheado Limão';
                break
            case '13':
                d.donut = 'Recheado Red Velvet';
                break
            case '14':
                d.donut = 'Especial Kit Kat';
                break
            case '15':
                d.donut = 'Especial Oreo';
                break
            case '16':
                d.donut = 'Especial Ovomaltine';
                break
            case '17':
                d.donut = 'Especial M&Ms';
                break
            case '18':
                d.donut = 'Especial Napolitano';
                break
            case '19':
                d.donut = 'Especial Paçoca';
                break
            case '20':
                d.donut = 'Especial Galak';
                break
            case '21':
                d.donut = 'Especial Kinder';
                break
            case '22':
                d.donut = 'Especial Sensação';
                break
            case '23':
                d.donut = 'Especial Torta de Limão';
                break
            case '24':
                d.donut = 'Especial Mousse de Maracujá';
                break
            case '25':
                d.donut = 'Não pedi donuts';
                break
        }
        ...
        switch (d.bebida) {
            case '1':
                d.bebida = 'Café Pequeno';
                break
            case '2':
                d.bebida = 'Café Médio';
                break
            case '3':
                d.bebida = 'Café Grande';
                break
            case '4':
                d.bebida = 'Cappuccino';
                break
            case '5':
                d.bebida = 'Cappuccino Europeu';
                break
            case '6':
                d.bebida = 'Chocolate Quente';
                break
            case '7':
                d.bebida = 'Frappuccino';
                break
            case '8':
                d.bebida = 'Água';
                break
            case '9':
                d.bebida = 'Água com Gás';
                break
            case '10':
                d.bebida = 'Coca-Cola';
                break
            case '11':
                d.bebida = 'Guaraná Antartica';
                break
            case '12':
                d.bebida = 'Chá Gelado';
                break
            case '13':
                d.bebida = 'Suco Natural';
                break
            case '14':
                d.bebida = 'Não pedi bebida';
                break
        }
